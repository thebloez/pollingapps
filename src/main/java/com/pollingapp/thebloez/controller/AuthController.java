...
import com.pollingapp.thebloez.exception.AppException;
...
import com.pollingapp.thebloez.payload.request.LoginRequest;
import com.pollingapp.thebloez.payload.request.SignUpRequest;
import com.pollingapp.thebloez.payload.response.ApiResponse;
import com.pollingapp.thebloez.payload.response.JwtAuthenticationResponse;
import com.pollingapp.thebloez.repository.RoleRepository;
import com.pollingapp.thebloez.repository.UserRepository;
import com.pollingapp.thebloez.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest){
        ...
        Role userRole = roleRepository.findByName(RoleName.ROLE_USER)
                .orElseThrow(() -> new AppException("User Role note set"));
